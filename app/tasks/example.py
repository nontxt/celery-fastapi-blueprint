...
def group_task(self, task_id, raise_error=False):
    ...
    try:
        ...
        self.update_state(
            state=states.FAILURE, meta={"exc_type": str(type(e)), "exc_message": str(e)}
        )
...
def run_group(raise_error=False):
    ...
    tasks = group([group_task.s(i, raise_error=raise_error) for i in range(5)])
